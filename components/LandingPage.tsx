...
const LandingPage: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#1b1b2b] via-[#24243a] to-[#151522] relative overflow-hidden px-0">
      {/* Background glow */}
      ...
      {/* Navigation */}
      <nav className="relative z-10 bg-[#1f1f2e]/90 backdrop-blur-xl border-b border-slate-800 px-6 py-4">
...
<span className="font-bold text-2xl text-white tracking-tight">
  NexaHub
            ...
            {/* <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-cyan-400 rounded-lg flex items-center justify-center text-white font-bold text-xl">GE</div>
            <span className="font-bold text-2xl text-white tracking-tight">GCE Erode</span> */}
          </div>
          <div className="flex items-center gap-4">
            <Link to="/login" className="px-5 py-2 text-slate-300 font-semibold hover:text-cyan-400 transition-colors">Login</Link>
            <Link to="/signup" className="px-5 py-2 bg-gradient-to-r from-indigo-500 to-cyan-400 text-white font-semibold rounded-lg hover:scale-105 shadow-md shadow-indigo-100 transition-all active:scale-95">Get Started</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="relative z-10 pt-20 pb-32 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-indigo-500 to-cyan-400 text-white rounded-full border border-indigo-400/30 text-sm font-bold animate-bounce shadow-lg">
            <Bell size={16} />
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold text-white tracking-tight leading-tight">
            Intelligent Digital <span className="text-cyan-400">Notification Framework</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link to="/signup" className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-indigo-500 to-cyan-400 text-white font-bold rounded-xl hover:scale-105 shadow-xl shadow-indigo-200 transition-all active:scale-95 text-lg">
              Sign Up Now
            </Link>
            <Link to="/login" className="w-full sm:w-auto px-8 py-4 bg-[#23233a] text-white font-bold rounded-xl border border-slate-700 hover:bg-[#23233a]/80 transition-all text-lg">
              Existing User Login
            </Link>
          </div>
        </div>
      ...
      {/* Features Grid */}
      <section className="relative z-10 bg-[#23233a]/80 py-24 px-6 border-y border-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white mb-4">Core Framework Features</h2>
            <div className="h-1.5 w-20 bg-gradient-to-r from-indigo-500 to-cyan-400 mx-auto rounded-full"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              { icon: <Shield className="text-cyan-400" />, title: "Secure & Role-Based", desc: "Access dashboards tailored exactly to your responsibilities as Student, Faculty, or Admin." },
              { icon: <FileCheck className="text-cyan-400" />, title: "Mandatory Ack Tracking", desc: "Ensure critical notices are read and acknowledged with real-time lifecycle monitoring." },
              { icon: <BarChart2 className="text-cyan-400" />, title: "Deep Analytics", desc: "Track engagement rates, department-wise statistics, and acknowledgment percentages." },
              { icon: <Users className="text-cyan-400" />, title: "Department Specific", desc: "Target messages precisely to specific batches, departments, or staff groups." },
              { icon: <Smartphone className="text-cyan-400" />, title: "Mobile Responsive", desc: "A seamless experience across all devices, ensuring you never miss an update." },
              { icon: <Bell className="text-cyan-400" />, title: "Smart Prioritization", desc: "Categorize notices by priority and type—from Academic to Emergency alerts." }
            ].map((feature, i) => (
              <div key={i} className="group p-8 rounded-2xl border border-slate-700 hover:border-cyan-400/40 hover:bg-cyan-400/5 transition-all duration-300 shadow-xl shadow-cyan-400/5">
                <div className="w-12 h-12 bg-gradient-to-br from-indigo-500 to-cyan-400 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  {feature.icon}
                </div>
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-[#181828] text-white py-12 px-6 border-t border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-cyan-400 rounded flex items-center justify-center"><img
             src="/college-logos.png"
             alt="GCE Erode Logo"
             className="w-12 h-12 object-contain"
          /></div>
            <span className="font-bold text-lg">NexaHub Framework</span>
          </div>
          <p className="text-slate-400 text-sm">© 2026 Government College of Engineering, Erode. All rights reserved.</p>
