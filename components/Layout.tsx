...
const Layout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1b1b2b] via-[#24243a] to-[#151522] flex flex-col md:flex-row pb-20 md:pb-0">
      {/* Mobile Header */}
      <div className="md:hidden bg-[#1f1f2e] border-b px-4 py-3 flex items-center justify-between sticky top-0 z-50">
      ...
      `}>
        <div className="h-full flex flex-col p-6">
          <div className="hidden md:flex items-center gap-3 mb-10">
             <div className="w-10 h-10 bg-indigo-500 rounded-lg flex items-center justify-center"><img
          ...
          /></div>
            <div> 
              ...
              <h1 className="font-bold text-lg leading-tight">NexaHub</h1>
